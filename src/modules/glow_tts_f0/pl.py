...
from .model import GlowTTSWithF0Model
from ..common.datasets import Dataset
from ..common.schedulers import Scheduler
from ..common.utils import add_prefix


class GlowTTSWithF0Module(LightningModule):
    def __init__(self, params):
        super(GlowTTSWithF0Module, self).__init__()
        self.params = params
        self.model = GlowTTSWithF0Model(params.model)
