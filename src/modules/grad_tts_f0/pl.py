...
from .model import GradTTSWithF0Model
from ..common.datasets import Dataset
from ..common.schedulers import Scheduler
from ..common.utils import add_prefix


class GradTTSWithF0Module(LightningModule):
    def __init__(self, params):
        super(GradTTSWithF0Module, self).__init__()
        self.params = params
        self.model = GradTTSWithF0Model(params.model)
